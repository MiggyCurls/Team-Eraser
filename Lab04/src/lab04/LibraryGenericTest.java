...
public class LibraryGenericTest {
  ...
  public static void main(String[] args) {
    ...
    booksCheckedOut1 = lib1.getInventoryList();
    booksCheckedOut2 = lib2.getInventoryList();
    /*booksCheckedOut1 list is organized from smallest to largest according to
      their Isbn number */
    System.out.println("test: " + booksCheckedOut1);
    System.out.println("test2: " + booksCheckedOut2);
    // test a medium library: you will use this for homework

    System.out.println("author: " + lib1.getOrderedByAuthor());
