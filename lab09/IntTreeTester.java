...
public class IntTreeTester {
	public static void main(String[] args){
		...
		if (!tree_ref2.printLevel(1).equals("2\n"))
			System.err.println("TEST FAILED: printLevel() with tree_ref2 1");
		
		
		if (!tree_ref2.printLevel(2).equals("8\n1\n"))
			System.err.println("TEST FAILED: printLevel() with tree_ref2 2 ");

		if (!tree_ref2.printLevel(3).equals("0\n7\n6\n"))
			System.err.println("TEST FAILED: printLevel() with tree_ref2 3");
